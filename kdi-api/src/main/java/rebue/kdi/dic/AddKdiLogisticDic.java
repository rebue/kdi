 ...
 *
 */
public enum AddKdiLogisticDic implements EnumBase {
     ...
     */
    @JsonCreator
    public static AddKdiLogisticDic getItem(int code) {
        EnumBase result = valueMap.get(code);
        if (result == null) {
            throw new IllegalArgumentException("输入的code" + code + "不在枚举的取值范围内");
        }
        return (AddKdiLogisticDic) result;
    }
